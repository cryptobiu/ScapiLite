...
import crypto.cs.biu.scapilite.model.PageResponse;
    ...
    private void getAllPolls()
    {
        ...
        JsonArrayRequest jsonRequest = new JsonArrayRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONArray>()
                {
                    ...
                    {
                        log("getAllPolls " + response.toString());
                        no_poll_wrapper.setVisibility(View.GONE);
                ...
                }, new Response.ErrorListener()
        {
            ...
            public void onErrorResponse(VolleyError error)
            {
                ...
                logError("getAllPolls error", error);
            }
        })
        {
            @Override
            public Map<String, String> getHeaders() throws AuthFailureError
            {
                ...
                log("TOKEN " + PreferencesManager.getAccessToken());
