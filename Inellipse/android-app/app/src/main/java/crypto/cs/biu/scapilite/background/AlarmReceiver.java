...
//        Poll poll = (Poll) intent.getExtras().getSerializable(AppConstants.CHOOSEN_POLL);
        ...
        log("AlarmReceiver1 pollStatus " + pollStatus);
        ...
        {
            log("AlarmReceiver1 before execution " + pollAnswer);
            log("AlarmReceiver1 before execution pollId " + pollId);
    ...
    public void prepareOnlinePoll(final Context context, String pollName)
    {
        ...
        log("AlarmReceiver prepareOnlinePoll " + url);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>()
                {
                    ...
                    {
                        log("getPollParams response  " + response);
                        ...
                        log("AlarmReceiver prepareOnlinePoll " + matrixResponse.toString());
                ...
                }, new Response.ErrorListener()
        {
            ...
            {
                logError("AlarmReceiver prepareOnlinePoll ", error);
            }
        });
    ...
    private void getCircuitFile(final Context context, String url)
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response)
                    {
                        log("getCircuitFile response  " + response);
                ...
                }, new Response.ErrorListener()
        {
            ...
            public void onErrorResponse(VolleyError error)
            {
                logError("getCircuitFile error ", error);
            }
        });
