...
public class SecurityHelper
{
    ...
    public static void generateKeyPair(String trans) throws NoSuchProviderException, NoSuchAlgorithmException, IOException
    {
        ...
        Logger.log("1111 publicKey alg " + publicKey.getAlgorithm());
        Logger.log("1111 publicKey getFormat " + publicKey.getFormat());
        Logger.log("1111 publicKey getEncoded().length " + publicKey.getEncoded().length);
        Logger.log("1111 privateKey alg " + privateKey.getAlgorithm());
        Logger.log("1111 privateKey getFormat " + privateKey.getFormat());
        Logger.log("1111 privateKey getEncoded().length " + privateKey.getEncoded().length);
...
//            KeyFactory keyFac = KeyFactory.getInstance(trans);
            ...
            Logger.log("encryptToRSAString " + encryptedBase64);
        }
        catch (Exception e)
        {
            Logger.logError("encryptToRSAString ", e);
        }
...
//            cipher.init(Cipher.DECRYPT_MODE, key, oaepParams);
            ...
            Logger.log("decryptRSAToString " + decryptedString);
        }
        catch (Exception e)
        {
            Logger.logError("decryptRSAToString e ", e);
        }
...
//        System.out.println("key "+Base64.encodeBase64String(key.getEncoded()));
            ...
            Logger.log("decryptRSAToString2 : " + new String(plainText));

        }
        catch (Exception e)
        {
            Logger.logError("decryptRSAToString2 e ", e);
        }
    }
...
//            }
            ...
            {
                Logger.logError("11122333 erm: ", erm);
            }
            ...
            {
                Logger.logError("11122 erm22: ", erm);
            }
