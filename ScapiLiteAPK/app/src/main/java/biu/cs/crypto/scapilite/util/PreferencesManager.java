...
import biu.cs.crypto.scapilite.application.AppController;
...
public class PreferencesManager
{
    ...
    {
        Logger.log("putPollAnswer111 " + SharedPreferencesKeys.POLL + "." + pollId + " answer= " + answer);
    ...
    {
        Logger.log("getPollAnswer111 " + SharedPreferencesKeys.POLL + "." + pollId + " answer= " + getContentSP().getString(SharedPreferencesKeys.POLL + "." + pollId, "") + "===");
...
//    }
    ...
    {
        Logger.log("getPrivate " + getContentSP().getString(SharedPreferencesKeys.PRIVATE, ""));
    ...
    {
        Logger.log("getPrivatePem " + getContentSP().getString(SharedPreferencesKeys.PRIVATE_PEM, ""));
    ...
    {
        Logger.log("getPublic" + getContentSP().getString(SharedPreferencesKeys.PUBLIC, ""));
    ...
    {
        Logger.log("getPublicPem" + getContentSP().getString(SharedPreferencesKeys.PUBLIC_PEM, ""));
    ...
    {
        Logger.log("getCiruitFileString " + getContentSP().getString(SharedPreferencesKeys.CIRCUIT_STRING, ""));
    ...
    public static void putMacAddress(String macAddress)
    {
        ...
        Logger.log("putMacAddress " + macAddress);
