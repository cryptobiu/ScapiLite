...
import biu.cs.crypto.scapilite.model.Token;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void registerUser(JSONObject jsonObject) {
        ...
        Logger.log("registerUser " + url);
        Logger.log("registerUser jsonObject " + jsonObject);
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, url, jsonObject, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                Logger.log("registerUser response " + response);
            ...
            public void onErrorResponse(VolleyError error) {
                Logger.logError("registerUser Error", error);
            }
        });
    ...
    private void loginUser(final String username, final String password) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Logger.log("login user response " + token);
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Logger.logError("login user  error ", error);
            }
        }) {
            @Override
...
//                params.put("client_id", AppConstants.CLIENT_ID);
    ...
    private void handleSignInResult(Task<GoogleSignInAccount> completedTask) {
        try {
            ...
            Logger.log("signInResult:Signed in successfully, show authenticated UI. " + account.toString());
            ...
            Logger.logError("signInResult:failed code=" + e.getStatusCode(), e);
//            updateUI(null);
        } catch (JSONException e) {
            e.printStackTrace();
        }
